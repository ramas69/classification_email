    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl p-10 shadow-sm text-center border border-gray-200">
          <p className="text-gray-600 mb-6">Configurez votre messagerie IMAP</p>
          <div className="flex flex-wrap gap-4 justify-center">
            <button
              type="button"
              onClick={() => setMode('imap_form')}
              className="flex items-center gap-3 px-8 py-4 bg-[#EF6855] text-white rounded-lg hover:bg-[#d55a47] shadow-md hover:shadow-lg transition-all"
            >
